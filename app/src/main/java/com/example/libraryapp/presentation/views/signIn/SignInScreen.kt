package com.example.libraryapp.presentation.views.signIn
...
import com.example.libraryapp.presentation.viewModel.SignInViewModel
...
fun SignInScreen(viewModel: SignInViewModel= viewModel()) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        LazyColumn(
            ...
            itemsIndexed(viewModel.signInPlaceholder) { index, item ->
                CommonTextInput(
                    value = viewModel.signInValue[index],
                    onValueChange = { viewModel.handleEnteredCreds(it, index) },
